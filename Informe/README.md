...
<p align="center">
    <img src="https://github.com/megyltv/Tecnologias_Web_Js/blob/08-Nodejs-02/Informe/imagenes/cap12.jpg?raw=true" width="500" height="">
</p>
...
<p align="center">
    <img src="https://github.com/megyltv/Tecnologias_Web_Js/blob/08-Nodejs-02/Informe/imagenes/cap15.jpg?raw=true" width="500" height="">
</p>
...
<p align="center">
    <img src="https://github.com/megyltv/Tecnologias_Web_Js/blob/08-Nodejs-02/Informe/imagenes/cap19.jpg?raw=true" width="500" height="">
</p>
...
- Node js es un servidor el cual permite instalar diferentes paquetes y librerías para utilizarlas en las aplicaciones. Así mismo, da la opción que estas puedan ser creadas por cada usuario y les permite publicarlas para que puedan ser utilizadas por otros usuarios.
- En el presente laboratorio se instaló Express y se definieron métodos para ejecutar los métodos HTTP.
...
- Parámetros, como el puerto, se pueden definir como variables globales. Esto permite no se encuentre quemado el valor en cada método y sea más fácil cambiar el valor en caso de ser necesario.
